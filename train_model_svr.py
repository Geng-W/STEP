...
output_file = rf'/path/to/output/svr_{current_time}_{split_ratio_str}_data.csv'
output_xlsx_file = rf'/path/to/output/svr_{current_time}_{split_ratio_str}_data.xlsx'
...
if use_grid_search:
    ...
    best_model = SVR(**merged_best_params)
    ...
    print(f"Running SVR experiment")
...
if output_csv:
    with open(output_file, 'w') as f:
        if use_grid_search:
            ...
            f.write("SVR Parameters: kernel='rbf', C=1.0, gamma='scale', epsilon=0.1\n")
